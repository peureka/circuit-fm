...
function ctaButton(text, url) {
  return `<p style="margin:24px 0;"><a href="${escapeHtml(url)}" style="display:inline-block;background:#FF4400;color:#000;font-family:'Courier New',Courier,monospace;font-size:14px;font-weight:600;text-decoration:none;padding:12px 28px;min-height:44px;line-height:20px;">${escapeHtml(text)}</a></p>`;
}
